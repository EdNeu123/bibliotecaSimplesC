...
int devolverLivro(Livro *biblioteca, int numLivros, const char *titulo) {
...
void devolverLivroUI(Livro *biblioteca, int numLivros) {
    char titulo[100];
    printf("Digite o título do livro a ser devolvido: ");
    fgets(titulo, sizeof(titulo), stdin);
    titulo[strcspn(titulo, "\n")] = '\0'; // Remover o newline

    if (devolverLivro(biblioteca, numLivros, titulo)) {
        printf("Livro devolvido com sucesso!\n");
    } else {
        printf("Falha ao devolver o livro. Verifique se o título está correto e se o livro está emprestado.\n");
    }
}
